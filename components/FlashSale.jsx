      ...
      <div className="relative group">
        ...
        >
          <motion.div
            ...
            className="absolute inset-0 rounded-full border-4 border-transparent border-t-red-500 border-r-red-500"
          />

          <div className="absolute inset-0 rounded-full bg-gradient-to-br from-red-600 to-red-800 shadow-lg flex items-center justify-center">
            <Image
              src="/bell.png"
              alt="Flash Sale"
              width={60}
        ...
        <AnimatePresence>
          {isContentVisible && (
            <motion.div
              className="fixed right-20 top-1/2 transform -translate-y-1/2 w-[85vw] max-w-md bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-xl shadow-2xl p-6 border border-gray-700"
            ...
            >
              ...
              >
                <div className="text-sm text-gray-300">Offer ends in:</div>
                <div className="flex items-center justify-center gap-2 bg-gray-800/80 px-6 py-3 rounded-lg border border-gray-700">
