    ...
    <div className="max-w-5xl mx-auto p-4 lg:p-8 space-y-8">
      ...
      >
        <div className="space-y-1">
          ...
          <p className="text-gray-400">Manage and review registered sellers</p>
        </div>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 w-full bg-gray-800 rounded-lg border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 outline-none"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-indigo-500"
          >
      ...
      {filteredSellers.length === 0 ? (
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-100">No Sellers Found</h2>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex gap-2 border-t border-gray-700 pt-4">
                  <button className="flex-1 py-2 px-4 text-sm bg-indigo-900/30 hover:bg-indigo-800 rounded-lg transition-colors">
                    View Profile
                  </button>
                  <button className="flex-1 py-2 px-4 text-sm bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
                    Message
                  </button>
                </div>
              </div>
